<div class="container">
  <h2 class="text-center">Training and Documentation</h2>
    <hr class="separation-line blue-bg"/>
        ...
        <h4>Instruction for SimCCS Gateway Hackathon at PEARC18</h4>
          <h5>Instructions</h5>
           <ul style="font-size:20px; list-style-type:square">
             ...
             <li>Download .geojson files for the hackathon</li>
                 <ul style="font-size:16px; list-style-type:square">
                     <li><a href="/themes/iu-geosurvey-gateway-theme/assets/img/Network.geojson" download>Network.geojson</a></li>
